...
=
ad_incorrect_caption = 'Твое описание слишком короткое или длинное!/n/nЛибо ты используешь слова и выражения, недопустимые в академической обстановке, будь внимательнее и попробуй что-то другое!👇'
