...
code_sent_caption = '<b>Проверь свою корпоративную почту!</b>\n\nТуда пришел код. Если не можешь найти письмо, посмотри папку "спам" или в крайнем случае напиши свою почту в лс поддержке @vwonders'
firewall_caption = 'Укажи именно свою студенческую, корпоративную почту!🤚'
