...
inactivity_caption = ["Хэй, ты тут? Отреагируешь на анкету, что я прислал?",
...
match_letter_caption = 'Поздравляю с мэтчем!🎉\n\nВремя ответного шага с твоей стороны: <b>оставь послание!</b>📨\n*подсказки, что туда можно написать, смотри на фото\n**изменить после отправки его будет уже нельзя'
matched = '<b>📨Тебе пришло послание от нового мэтча, гляди:</b>'
