...
ad_incorrect_caption = 'Кхм, в твоем описании присутствуют недопустимые в академической среде университета слова и выражения, будь внимательнее и попробуй что-то другое!👇'
