...
ad_text_caption = ('Вот мы и разобрались с фото,...\n\n<b>ШАГ 8/8📝</b>\nПоследнее действие - напиши описание!\n'
                   'Эта часть - самая важная.\n\n<b>Опиши, чего хочешь, расскажи о себе, предложи что-то</b>\n\n<i>максимум 888 символов</i>')
ad_text_placeholder = 'Это твой твиттер'

ad_short_caption = 'Слишком короткое описание, попробуй что-то другое!👇'
ad_long_caption = 'Слишком длинное описание, попробуй что-то другое!👇'
ad_incorrect_caption = 'Твое описание слишком короткое или длинное!/n/nЛиибо ты используешь слова и выражения, недопустимые в академической обстановке, будь внимательнее и попробуй что-то другое!👇'
