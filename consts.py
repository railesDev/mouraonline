...
inactivity_caption = ["Хэй, ты тут? Мне грустно без тебя:(",
                      ...
                      "Вернемся в мир Муры?",
                      "Еще хочешь с кем-то знакомиться?",
                      "Хэээй, тут еще много людей, с которыми стоит пообщаться!",
                      "Если не хочешь больше пользоваться мурой, заморозь профиль в главном меню!",
                      "ТЕБЕ ПРИЛЕТЕЛ ЛАЙК! Хочешь знать, кто это? Зайди в чат!\n(ладно, это кликбейт, просто напоминаю о себе, ведь, наверное, телега у тебя и так перегружена)"]
...
no_ad_respond_caption = ["Хэй, ты тут? Отреагируешь на анкету, что я прислал?",
                      ...
                      "Йоу, тут человечек ждет твоей реакции!",
                      "Если не хочешь больше пользоваться мурой, заморозь профиль в главном меню!"]
...
inter_intro = 'AgACAgIAAxkBAAECAc9mJvDmTJUOssGdS5s1bNfaoMSqCgACMd8xG6YIOUkxE0kTbZ1gTQEAAwIAA3kAAzQE'
inter_question = 'Привет!👋 Спасибо за твой визит на Мура Ток!\nДавай посмотрим, что же тебе выпадет...:\n\n<b>'
...
inter_ending = 'AgACAgIAAxkBAAECAflmJvEvQ4GLaM5GbgXQspeE20pc1wACMt8xG6YIOUmLR2gI83fQEwEAAwIAA3kAAzQE'
inter_finish = '🏄‍♀️ Прием! Вот юзернейм: '
inter_finish_ = '\n\nА вот ответ на вопрос:\n\n'
inter_final = '\n\n🔮Чтобы вернуться в обычный режим Муры - зарегистрироваться или вернуться в профиль, отправь /start'
...
blacklisted_caption = 'Сорри, но ты не следуешь нашим правилам, поэтому ты <b>в черном списке 🐍</b>\n\nЕсли хочешь повлиять на ситуацию, напиши @vwonders!'
got_banned = 'Предупреждение было вынесено, урок не извлекаешь, а правила нарушены. Так что я вынужден ограничить тебе доступ к муре. \n\nЕсли хочешь повлиять на ситуацию, напиши @vwonders!'
got_unbanned = '<b>🧞От Рэя:</b>\nЯ тебя разбанил, надеюсь, теперь ты будешь следовать нашим простым правилам 🥺\n\nОтправь боту /start! За кодом обратись ко мне в лс, если не помнишь'
publish_ad = 'Опубликовать 🏹!'
publish_placeholder = 'Все готово?'
...
intro_caption = ("<b>Привет!👋 Канал для анонсов: @mourahse</b>\n<u>Не забудь подписаться,</u> чтобы ничего не пропустить!\n\nМы заботимся о безопасности и приватности студентов вышки, поэтому Мура не будет работать, пока ты не пройдешь проверку!\n\n<b>Введи свою студенческую почту:</b>\n"
                 "<i>*туда придет одноразовый код</i>")
channel_ad = "☝️ <b>Напомню:</b> у Муры есть свой канал:\n\n👉@mourahse👈\n\n<b>Обязательно подпишись!</b> У нас есть интересные новости для тебя! Также ты будешь оставаться в курсе всех обновлений, да и в целом, блин, я же ради тебя канал веду и стараюсь, дизайню посты, хахаха"
...
code_sent_photo = 'https://cutt.ly/WwVQDY2C'
code_sent_caption = '<b>Проверь свою корпоративную почту!</b>\n\nТуда пришел код вида XXXXXMU27.\n<b>Введи его в ответ:</b>\n\n<i>*если не можешь найти письмо, посмотри папку "спам" или в крайнем случае напиши свою почту в лс поддержке @vwonders</i>'
firewall_caption = 'Неверный код! Попробуй еще раз🤚'
...
campus_photo = 'https://cutt.ly/cwZEwa5e'
...
dislike_caption = "Окей, проходим мимо😶‍🌫️"

complain_caption = "Пожалуйста, перешли сообщение с анкетой Рэю - @vwonders, он разберется!🥶"

match_photo = 'https://cutt.ly/iwZEegqp'
match_letter_caption = 'Поздравляю с мэтчем!🎉\n\nВремя ответного шага с твоей стороны: <b>оставь текстовое послание!</b>📨\n\nЕсли для тебя это важно, не забудь указать <b>юзернейм в тг</b>, иначе человек тебе не сможет ответить!\n\n\n*подсказки смотри выше, изменить послание после отправки будет уже нельзя!'
matched = ['<b>🎉Тебе пришло послание от нового мэтча!</b>\n\n', '<b>📨Текст послания:</b>']
letter_sent_caption = 'Твое послание успешно отправлено! 📨'

valentine_sent = 'Твоя анонимная валентинка успешно отправлена!\nРэй ее промодерирует и опубликует в канале 🤙'
short_valentine = 'Твоя валентинка слишком короткая(\nПопробуй снова по команде "/valentine ...", где "..." - текст твоей валентинки!👇'
